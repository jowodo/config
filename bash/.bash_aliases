...
GITCONFPATH=/home/pur/Documents/config_files
alias getconf="cd $GITCONFPATH && git pull && source ~/.bashrc && cd -"
alias gitconf="cd $GITCONFPATH && git add * && git commit && git push && source ~/.bashrc && cd - "
