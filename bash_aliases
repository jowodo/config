...
alias gp="gnuplot"
alias via="vim $XDG_CONFIG_HOME/bash_aliases"
alias vif="vim $XDG_CONFIG_HOME/bash_functions"
alias vis="vim ~/.ssh/config"
alias vir="vim $XDG_CONFIG_HOME/bashrc"
alias vil="vim ~/.bash_local"
alias vii="vim $XDG_CONFIG_HOME/i3/config"
alias viv="vim ~/.vimrc"
alias sus="source $XDG_CONFIG_HOME/bashrc "
